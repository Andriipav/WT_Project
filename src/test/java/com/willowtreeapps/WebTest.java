...
public class WebTest {
	 ...
	 * type The chrome WebDrivers are included on the root of this project, to
	 * get the latest versions go to
	...
	@Test
	public void triesAndCorrectAnswersCountersTest() {
		new HomePage(driver).checkTriesAndCorrectAnswersCounters();
	}

	@Test

	public void validateNameAndPhotosChangeTest() {
		new HomePage(driver).validateNameAndPhotosChange();
	}

	@Test
	public void validateStreakCounterResetTest() {
		new HomePage(driver).validateStreakCounterReset();
	}
